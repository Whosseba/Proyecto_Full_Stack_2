...
const DetalleProducto = () => {
    ...
    // Usamos el nombre de archivo (producto.imagen) y lo combinamos con el endpoint de servicio.
    const imageUrl = producto.imagen 
        ? `${BACKEND_URL}/api/productos/images/${producto.imagen}`
        : ''; // Si no hay nombre de archivo, la URL está vacía.
            ...
            <div className="row">
                <div className="col-md-6 mb-4">
                    ...
                    >
                        {producto.imagen && (
                            <img
                                src={imageUrl} // <-- Usamos la URL generada
                                alt={producto.nombre}
                                className="img-fluid rounded"
                                onError={(e) => {
                                    // Si la imagen falla, podemos ocultarla o poner un placeholder
